...
export default function TodoSection({
    ...
    const [datePickersOpen, setDatePickersOpen] = useState<Record<number, boolean>>({});
                        ...
                        <div className="flex justify-between items-start gap-4">
                            <div className="flex items-start gap-3 w-full">
                                ...
                                <div className="flex-1">
                                    <p
                                        className={`text-white break-words ${todo.done ? "line-through opacity-60" : ""
                                            }`}
                                    >
                                        {todo.item}
                                    </p>
                                    ...
                                    <div className="text-sm text-gray-400 mt-1">
                                        Priority: {todo.priority || "None"} | Due: {todo.date_due ? new Date(todo.date_due).toLocaleString() : "Not set"}
                                    </div>
                                </div>
                            </div>
                            ...
                            {openNotes[todo.id] && (
                                <div className="mt-2">
                                    <textarea
                                        ...
                                        onChange={(e) =>
                                            setNoteInputs((prev) => ({ ...prev, [todo.id]: e.target.value }))
                                        }
